...
const specs: BarSpec[] = [
  ...
  // 主歌一 6–18（||: B SB B S [x3] | B SB BB S [x3] :|| B B B 0 |，共 13 小节）
  spec("a", { section: "主歌", lyric: "暖阳下 我迎芬芳", lyricBeats: ["暖阳", "下", "我迎", "芬芳"] }),
  spec("a", { lyric: "是谁家的姑娘", lyricBeats: ["是谁", "家的", "姑娘", ""] }),
  spec("a", { lyric: "我走在了那座小桥上", lyricBeats: ["我走", "在了", "那座", "小桥"] }),
  spec("b", { lyric: "你抚琴奏忧伤", lyricBeats: ["上你", "抚琴", "奏忧", "伤"] }),
  spec("b", { lyric: "桥边歌唱的小姑娘", lyricBeats: ["桥边", "歌唱", "的小", "姑娘"] }),
  spec("b", { lyric: "你眼角在流淌", lyricBeats: ["你眼", "角在", "流淌", ""] }),
  spec("a", { lyric: "你说一个人在逞强", lyricBeats: ["你说", "一个", "人在", "逞强"] }),
  spec("a", { lyric: "一个人念家乡", lyricBeats: ["一个", "人念", "家乡", ""] }),
  spec("a", { lyric: "风华模样", lyricBeats: ["风华", "模样", "", ""] }),
  spec("b", { lyric: "你落落大方", lyricBeats: ["你落", "落大", "方", ""] }),
  spec("b", { lyric: "坐在桥上", lyricBeats: ["坐在", "桥上", "", ""] }),
  spec("b", { lyric: "我听你歌唱", lyricBeats: ["我听", "你歌", "唱", ""] }),
  spec("bbb0", { lyric: "我说", lyricBeats: ["", "", "", "我说"] }),

  // 副歌一 19–29（||: B SB BB S [x3] | B SB BB SS [x2] :|| B SB BB S |，共 11 小节）
  spec("b", { section: "副歌", lyric: "桥边姑娘", lyricBeats: ["桥边", "姑娘", "", ""] }),
  spec("b", { lyric: "你的芬芳", lyricBeats: ["你的", "芬芳", "", ""] }),
  spec("b", { lyric: "我把你放心上", lyricBeats: ["我把", "你放", "心上", ""] }),
  spec("bss", { lyric: "刻在了我心膛", lyricBeats: ["刻在", "了我", "心膛", ""] }),
  spec("bss"),
  spec("b", { lyric: "桥边姑娘", lyricBeats: ["桥边", "姑娘", "", ""] }),
  spec("b", { lyric: "你的忧伤", lyricBeats: ["你的", "忧伤", "", ""] }),
  spec("b", { lyric: "我把你放心房", lyricBeats: ["我把", "你放", "心房", ""] }),
  spec("bss", { lyric: "不想让你流浪", lyricBeats: ["不想", "让你", "流浪", "嗯"] }),
  spec("bss", { lyric: "...", lyricBeats: ["...", "", "", ""] }),
  spec("b"),

  // 间奏 30–33（| 0 0 0 0 [x4] |，共 4 小节休止）
  spec("rest", { section: "间奏" }),
  spec("rest"),
  spec("rest"),
  spec("rest"),

  // 主歌二 34–46（||: B SB B S [x3] | B SB BB S [x3] :|| B B B 0 |，共 13 小节）
  spec("a", { section: "主歌", lyric: "暖阳下 的桥头旁", lyricBeats: ["暖阳", "下的", "桥头", "旁"] }),
  spec("a", { lyric: "有这样一姑娘", lyricBeats: ["有这", "样一", "姑娘", ""] }),
  spec("a", { lyric: "她有着长长的乌黑发", lyricBeats: ["她有", "着长", "长的", "乌黑"] }),
  spec("b", { lyric: "一双眼明亮", lyricBeats: ["发一", "双眼", "明亮", ""] }),
  spec("b", { lyric: "姑娘你让我心荡漾", lyricBeats: ["姑娘", "你让", "我心", "荡漾"] }),
  spec("b", { lyric: "小鹿在乱撞", lyricBeats: ["小鹿", "在乱", "撞", ""] }),
  spec("a", { lyric: "你说无人在身旁", lyricBeats: ["你说", "无人", "在身", "旁"] }),
  spec("a", { lyric: "一个人在流浪", lyricBeats: ["一个", "人在", "流浪", ""] }),
  spec("a", { lyric: "风华模样", lyricBeats: ["风华", "模样", "", ""] }),
  spec("b", { lyric: "你落落大方", lyricBeats: ["你落", "落大", "方", ""] }),
  spec("b", { lyric: "坐在桥上", lyricBeats: ["坐在", "桥上", "", ""] }),
  spec("b", { lyric: "我听你歌唱", lyricBeats: ["我听", "你歌", "唱", ""] }),
  ...
  // 副歌二 47–57（||: B SB BB S [x3] | B SB BB SS [x2] :|| B SB BB S |，共 11 小节）
  spec("b", { section: "副歌", lyric: "桥边姑娘", lyricBeats: ["桥边", "姑娘", "", ""] }),
  spec("b", { lyric: "你的芬芳", lyricBeats: ["你的", "芬芳", "", ""] }),
  spec("b", { lyric: "我把你放心上", lyricBeats: ["我把", "你放", "心上", ""] }),
  spec("bss", { lyric: "刻在了我心膛", lyricBeats: ["刻在", "了我", "心膛", ""] }),
